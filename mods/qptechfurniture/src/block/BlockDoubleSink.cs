...
{
	public class BlockDoubleSink : ModdedBlockLiquidContainerBase
	{
		...
		public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
		{
			...
			BlockEntityDoubleSink besink = null;
			if (blockSel.Position != null)
			{
				besink = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityDoubleSink;
			}
