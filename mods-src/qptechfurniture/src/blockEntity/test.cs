...
namespace QptechFurniture.src
{
    ...
    public class BlockEntityLongPlantContainer : BlockEntityContainer, ITexPositionSource
    {
        ...
        public BlockEntityLongPlantContainer()
        {
        ...
        PlantContainerProps PlantContProps
        {
            get
            {
                return GetProps(inv[0].Itemstack);
            }
        }
