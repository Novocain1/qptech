...
{
    class BlockEntityIceBox : BlockEntityOpenableContainer
    {
        bool isChilled = true;
        ...
        public override void FromTreeAttributes(ITreeAttribute tree, IWorldAccessor worldForResolving)
        {
            ...
            preserveBonus = tree.GetFloat("preserveBonus", preserveBonus);
        ...
        {
            BlockIceBox block = Block as BlockIceBox;
            if (Block == null)
            {
                block = Api.World.BlockAccessor.GetBlock(Pos) as BlockIceBox;
                Block = block;
            }
        ...
        public override float GetPerishRate()
        {
            ...
            if (isChilled == true) { prate = prate * preserveBonus; }
            return prate;
        }
