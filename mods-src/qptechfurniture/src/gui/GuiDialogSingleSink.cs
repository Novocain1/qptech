...
{
	public class GuiDialogSingleSink : GuiDialogBlockEntity
	{
		...
		public GuiDialogSingleSink(string dialogTitle, InventoryBase inventory, BlockPos blockEntityPos, ICoreClientAPI capi) : base(dialogTitle, inventory, blockEntityPos, capi)
		{
