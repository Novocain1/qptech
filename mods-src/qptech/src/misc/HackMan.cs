...
namespace qptech.src
{
    public static class HackMan
    {
        ...
        public static void SetProperty(this object instance, string fieldname, object setVal) => AccessTools.Property(instance.GetType(), fieldname).SetValue(instance, setVal);
